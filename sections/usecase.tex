...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.4]{images/usecase/Sơ đồ usecase tổng quát.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.4]{images/usecase/usecase đăng ký.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.4]{images/usecase/usecase đăng nhập.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{images/usecase/usecase đăng xuất.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{images/usecase/usecase đổi mật khẩu.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{images/usecase/usecase chỉnh sửa thông tin.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{images/usecase/usecase tìm kiếm đối tượng.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{images/usecase/usecase xem chi tiết sản phẩm.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{images/usecase/usecase quản lí giỏ hàng.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{images/usecase/usecase quản lí danh sách yêu thích.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{images/usecase/usecase đặt hàng.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{images/usecase/usecase theo dõi đơn hàng.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{images/usecase/usecase quản lí sản phẩm.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{images/usecase/usecase quản lí thuộc tính.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{images/usecase/usecase quản lí đơn hàng.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{images/usecase/usecase quản lí danh mục.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{images/usecase/usecase quản lí khuyến mãi.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{images/usecase/usecase quản lí phân quyền.png}
...
\subsection{Usecase Quản lí người dùng}
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{images/usecase/usecase quản lí người dùng.png}
    \caption{Sơ đồ Use Case Quản lí người dùng}
\end{figure}

\begin{longtable}{|m{4cm}|m{10cm}|}
    \hline
    \textbf{Tên Use Case} & \textbf{Quản lí người dùng} \\
    \hline
    Tác nhân & Quản trị viên \\
    \hline
    Mô tả &
    Cho phép quản trị viên tạo, chỉnh sửa, xoá, khoá hoặc tìm kiếm người dùng trong hệ thống. Chức năng này giúp quản lý thông tin tài khoản, đảm bảo quyền truy cập hợp lệ và bảo mật hệ thống. \\
    \hline
    Điều kiện kích hoạt &
    Quản trị viên chọn chức năng \textit{Quản lí người dùng} trong giao diện quản trị. \\
    \hline
    Tiền điều kiện &
    Quản trị viên đã đăng nhập và có quyền truy cập vào chức năng quản lý người dùng. \\
    \hline
    Hậu điều kiện &
    \begin{itemize}
        \item \textbf{Nếu thành công:} Dữ liệu người dùng được thêm, sửa hoặc xoá thành công; thông tin cập nhật trong hệ thống và có hiệu lực ngay; ghi nhận thao tác vào nhật ký hệ thống.
        \item \textbf{Nếu thất bại:} Không có thay đổi nào được áp dụng; hệ thống hiển thị thông báo lỗi (ví dụ: tên đăng nhập trùng, dữ liệu không hợp lệ, lỗi kết nối...).
    \end{itemize} \\
    \hline
    Luồng sự kiện chính &
    \begin{enumerate}[label=\arabic*.]
        \item Quản trị viên chọn chức năng \textit{Quản lí người dùng}.
        \item Hệ thống hiển thị danh sách người dùng.
        \item Quản trị viên chọn thao tác: \textit{Thêm mới}, \textit{Chỉnh sửa}, \textit{Xoá}, hoặc \textit{Khoá/Mở khoá}.
        \item Nếu \textit{Thêm mới}/\textit{Chỉnh sửa}: nhập thông tin (họ tên, email, tài khoản, mật khẩu, vai trò...).
        \item Quản trị viên chọn \textit{Lưu}.
        \item Hệ thống kiểm tra hợp lệ, lưu thay đổi và hiển thị kết quả.
        \item Kết thúc Use Case.
    \end{enumerate} \\
    \hline
    Luồng sự kiện phụ &
    \begin{enumerate}[label=\textbf{\arabic*.}, leftmargin=1.2em]
        \item \textbf{Tên đăng nhập bị trùng}
            \begin{enumerate}[label*=\arabic*.]
                \item Hệ thống phát hiện tên đăng nhập đã tồn tại.
                \item Hiển thị cảnh báo và yêu cầu nhập lại.
            \end{enumerate}
        \item \textbf{Hủy thao tác}
            \begin{enumerate}[label*=\arabic*.]
                \item Quản trị viên hủy bỏ thao tác.
                \item Hệ thống quay lại danh sách người dùng.
            \end{enumerate}
    \end{enumerate} \\
    \hline
    Các yêu cầu đặc biệt &
    \begin{itemize}
        \item Cho phép tìm kiếm người dùng theo tên, email, vai trò, trạng thái.
        \item Hỗ trợ khoá/mở khoá tài khoản nhanh.
        \item Ghi nhận lịch sử thay đổi để truy vết hoạt động quản trị.
    \end{itemize} \\
    \hline
\end{longtable}


\subsection{Usecase Báo cáo thống kê}
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{images/usecase/usecase thống kê.png}
    \caption{Sơ đồ Use Case Báo cáo thống kê}
\end{figure}

\begin{longtable}{|m{4cm}|m{10cm}|}
    \hline
    \textbf{Tên Use Case} & \textbf{Báo cáo thống kê} \\
    \hline
    Tác nhân & Quản trị viên \\
    \hline
    Mô tả &
    Cung cấp chức năng xem, lọc và xuất các báo cáo thống kê trong hệ thống.  
    Gồm các thống kê con: \textit{Thống kê người dùng}, \textit{Thống kê doanh thu}, và \textit{Thống kê đơn hàng}.  \\
    \hline
    Điều kiện kích hoạt &
    Tác nhân chọn chức năng thống kê trong hệ thống. \\
    \hline
    Tiền điều kiện &
    \begin{itemize}
        \item Tác nhân đã đăng nhập và có quyền xem báo cáo.
        \item Hệ thống có dữ liệu thống kê được cập nhật từ các nghiệp vụ khác.
    \end{itemize} \\
    \hline
    Hậu điều kiện &
    \begin{itemize}
        \item \textbf{Nếu thành công:}  
        Báo cáo hiển thị chính xác; Quản trị viên xem được các loại thống kê.
        \item \textbf{Nếu thất bại:}  
        Không hiển thị hoặc cập nhật dữ liệu; hệ thống báo lỗi (kết nối, tham số lọc...); người dùng có thể chỉnh lại điều kiện hoặc thử lại.
    \end{itemize} \\
    \hline
    Luồng sự kiện chính &
    \begin{enumerate}[label=\arabic*.]
        \item Tác nhân chọn chức năng \textit{Báo cáo thống kê}.
        \item Hệ thống hiển thị giao diện thống kê tổng hợp.
        \item Tác nhân chọn loại thống kê: \textit{Người dùng}, \textit{Doanh thu}, hoặc \textit{Đơn hàng}.
        \item Hệ thống cập nhật dữ liệu và hiển thị biểu đồ/bảng.
        \item Kết thúc Use Case.
    \end{enumerate} \\
    \hline
    Luồng sự kiện phụ &
    \begin{enumerate}[label=\textbf{\arabic*.}, leftmargin=1.2em]
        \item \textbf{Không có dữ liệu phù hợp}
            \begin{enumerate}[label*=\arabic*.]
                \item Bộ lọc không có kết quả.
                \item Hệ thống hiển thị thông báo và gợi ý nới lỏng điều kiện.
            \end{enumerate}
        \item \textbf{Lỗi tải dữ liệu}
            \begin{enumerate}[label*=\arabic*.]
                \item Hệ thống lỗi khi truy vấn dữ liệu.
                \item Hiển thị thông báo lỗi, cho phép tải lại.
            \end{enumerate}
    \end{enumerate} \\
    \hline
    Các yêu cầu đặc biệt &
    \begin{itemize}
        \item Cho phép lọc linh hoạt theo thời gian, loại sản phẩm, nhân viên, khu vực...
        \item Hỗ trợ xuất báo cáo định dạng CSV, XLSX, PDF.
        \item Ghi lại nhật ký truy cập và thao tác xuất báo cáo.
    \end{itemize} \\
    \hline
\end{longtable}