...
\fancyfoot[r]{\textit{\textcolor{red}{Đồ án II}}}
...
\begin{center}
	...
	\bfseries Xây dựng website bán đồ điện tử
\end{center}
...
GVHD:& ThS. Nguyễn Thị Huyền Linh
\\
SVTH:& Phạm Văn Khiêm\\
MSSV: & 20195892\\
...
Thực hành phân tích, thiết kế và cài đặt một hệ thống đơn giản
\vspace{3cm}
\\
...
\vspace{3 cm}
\hspace{9.3cm} {\bf ThS. Nguyễn Thị Huyền Linh}\rm
	%\end{center}	
%\end{minipage}
\restoregeometry
...
\bigskip
\\
\indent Đầu tiên, em xin gửi lời cảm ơn đến ThS. Nguyễn Thị Huyền Linh, cô đã chỉ bảo em tận
...
\chapter{Khảo sát \cite{nguyenthhuyen2019}}
\section{Tại sao phải xây dựng website bán hàng \cite{tranngocthang2020}}
